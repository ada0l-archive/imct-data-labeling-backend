...
from backend.dataset.schemas import DatasetInCreatePydantic, DatasetInUpdatePydantic, DatasetPydantic
...
async def create_dataset(
    ...
    return await dataset_rep.create(obj_in,
